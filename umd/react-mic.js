...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__AudioContext__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_audio_recorder_polyfill__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_audio_recorder_polyfill___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_audio_recorder_polyfill__);
    ...
    this.startRecording = function () {
      ...
      if (navigator.mediaDevices) {
        navigator.mediaDevices.getUserMedia(constraints).then(function (str) {
          stream = str;
          mediaRecorder = new __WEBPACK_IMPORTED_MODULE_1_audio_recorder_polyfill___default.a(str);
          if (onStartCallback) {
            onStartCallback();
          };
